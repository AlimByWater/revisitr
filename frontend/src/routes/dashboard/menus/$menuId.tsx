...
export default function MenuDetailPage() {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      ...
      <div className="bg-white rounded border border-neutral-900 p-6 animate-in animate-in-delay-2">
        <div className="mb-5">
          <p className="font-mono text-[10px] uppercase tracking-wider text-neutral-300 mb-1">
            Точки продаж
          </p>
          <h2 className="text-sm font-semibold text-neutral-700">Привязка меню к POS</h2>
        </div>
